...
var googleMapsLoader = __webpack_require__(35);
...
var googleMapsKey = "AIzaSyDn9LPfEgLCJ0Rwn1nSDdNr-YTQlvuDML0";
...
var cities = {
   ...
   */
};function addPins(data, map) {
  var openif = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
function buildMap(map, elem, center, zoom) {
  var pancontrol = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'cooperative';
  var zoomcontrol = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : true;
